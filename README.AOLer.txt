...
AOLer directory to a new name, and then manually replace AOLer
...
To load the plugin with specific settings, use the format:
  -loadplugin AOLer,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin AOLer,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin AOLer,<configfilename>
For example:
  -loadplugin AOLer,myconfig.cfg
